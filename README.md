Auto-configurator of ipv4 → ipv6 http proxy. Redirect connections from different ports at one ipv4 address to unique random ipv6 address from \64 subnetwork
